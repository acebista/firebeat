...
const HRPanel = React.lazy(() => import('./components/admin/HRPanel')); // Default export assumed for HRPanel as it was imported as such
...
const PastTrips = React.lazy(() => import('./pages/delivery/PastTrips').then(module => ({ default: module.PastTrips })));
...
const App: React.FC = () => {
  return (
    <AuthProvider>
      ...
      />
      <HashRouter>
        <Suspense fallback={<LoadingOverlay message="Initializing App..." />}>
          <Routes>
