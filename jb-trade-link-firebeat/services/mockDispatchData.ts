...
export const VEHICLES: Vehicle[] = [
  { id: 'v1', name: 'Tata Ace (Van 1)', registrationNo: 'KA-01-1234', capacityCases: 100, isActive: true, createdAt: new Date().toISOString() },
  { id: 'v2', name: 'Bolero (Van 2)', registrationNo: 'KA-02-5678', capacityCases: 150, isActive: true, createdAt: new Date().toISOString() },
  { id: 'v3', name: 'Bike A', registrationNo: 'KA-03-9012', capacityCases: 20, isActive: true, createdAt: new Date().toISOString() },
];
