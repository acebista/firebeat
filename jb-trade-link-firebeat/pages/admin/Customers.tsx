      ...
      <Modal isOpen={isModalOpen} onClose={() => setModalOpen(false)} title={currentCustomer ? "Edit Customer" : "Add Customer"} size="lg">
        <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Input label="Shop Name" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} error={validationErrors.name} />
            <Input label="Phone Number" value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })} error={validationErrors.phone} />
            <Input label="PAN Number (Optional)" value={formData.panNumber} onChange={e => setFormData({ ...formData, panNumber: e.target.value })} error={validationErrors.panNumber} />
            <Input label="Route Name" value={formData.routeName} onChange={e => setFormData({ ...formData, routeName: e.target.value })} error={validationErrors.routeName} />
            ...
            <div className="col-span-2 bg-gray-50 p-3 rounded border border-gray-200 mt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Input
                  ...
                  error={validationErrors.creditDays}
                />
              </div>
            </div>
